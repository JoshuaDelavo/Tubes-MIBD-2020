        ...
        <main>
            ...
            <form method="POST" action="<?= base_url('admin/update') ?>">
                ...
                <div class="form-group row col-7">
                    ...
                    <div class="col-sm-10">
                        <input type="email" class="form-control" name="warna" id="warna" value="<?= $dataS['warna'] ?>">
                    </div>
                </div>
                <div class="form-group row col-7">
                    <label for="inputEmail3" class="col-sm-2 col-form-label">Tarif</label>
                    <div class="col-sm-10">
                        <input type="email" class="form-control" name="tarif" id="tarif" value="<?= $dataS['tarif'] ?>">
                    </div>
                </div>
                <div class="form-group row col-7">
                    ...
                    <div class="col-sm-10">
                        <div class="row">
                            <div class="col-sm-3">
                                <img src="../asset/image/<?= $dataS['gambar'] ?>" class="img-thumbnail">
                            </div>
                            <div class="col-sm-9">
